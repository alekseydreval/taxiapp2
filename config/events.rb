...
WebsocketRails::EventMap.describe do
  ...
  # Uncomment and edit the next line to handle the client connected event:
    # subscribe :new_suggestion, :to => NotificationController, :with_method => :new_suggestions
  #
  ...
  namespace :tracker do
    subscribe :update_location, :to => CarTrackerController, :with_method => :update_location
    subscribe :get_drivers_location, :to => CarTrackerController, :with_method => :get_drivers_location
  end
  # namespace :chat do
  #   subscribe :new_message, :to => ChatController, :with_method => :new_message
  #   subscribe :set_connection_id, :to => ChatController, :with_method => :set_connection_id
  # end
end
